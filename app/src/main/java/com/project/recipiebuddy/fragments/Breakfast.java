...
import com.project.recipiebuddy.model.Recipie;
import com.project.recipiebuddy.model.RecipieSteps;
...
public class Breakfast extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        apiService.getRecipesByTime(0).enqueue(new Callback<ArrayList<Recipe>>() {
            ...
            public void onResponse(Call<ArrayList<Recipe>> call, Response<ArrayList<Recipe>> response) {
                ...
                RecycleAdapters reAdp = new RecycleAdapters(cardList,view.getContext(),0);
